  ...
  <div class="container" v-loading="loading">
    ...
    <div class="form-container">
      ...
      <div class="input-v" :data-error-msg="nameError === nameErrorMsg ? nameErrorMsg : ''">
        <el-input size="mini" v-model.trim="newGroup.name" />
      </div>
      ...
      <el-button size="mini" class="cancel" @click="$router.go(-1)">
        Cancel
      </el-button>
      ...
      submitHandler () {
        if (this.nameError === '') {
          ...
          SPPCloudApi
            ...
            .then(r => this.$router.push('/templates/' + r.data.result.template_id))
            .catch(e => {
              this.loading = false
